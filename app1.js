...
let nedal=document.getElementById('nedal')
...
function submitFunction(event)
{
    ...
    let nameField=event.target.nameId.value;
    let minField=parseInt(event.target.minId.value)
    let maxField=parseInt(event.target.maxId.value)
    let avgField=parseFloat(event.target.avgId.value)
